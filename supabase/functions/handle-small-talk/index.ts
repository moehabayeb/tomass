    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are Tomas, a friendly English conversation teacher. The user just made a ${intent === 'question' ? 'question' : 'small talk comment'}.

Rules:
1. Answer briefly in 1-2 sentences (be natural and friendly)
...
- User: "Do you like pizza?" → "I love pizza! Pepperoni is my favorite. What's your favorite food to cook at home?"`
          },
          {
            role: 'user',
