...
serve(async (req) => {
  ...
  try {
    ...
    openAIFormData.append('prompt', 'The user is speaking single letters for a word game. Transcribe clearly spoken letters or words.') // Better for letter recognition
