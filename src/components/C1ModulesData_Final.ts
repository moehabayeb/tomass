...
**Situational Leadership Phrases:**`,
  ...
  table: [
    { english: "Delegating Tasks", turkish: "Görev Devretme", example: "I'd like you to take the lead on this project. I trust your judgment on the approach." },
    { english: "Giving Feedback", turkish: "Geri Bildirim Verme", example: "I appreciate your effort on this. Let's discuss how we can refine the approach for better results." },
    { english: "Motivating", turkish: "Motive Etme", example: "Your contributions have been invaluable. This next challenge is perfect for your skills." },
    { english: "Setting Expectations", turkish: "Beklenti Belirleme", example: "To succeed here, we need clear communication, accountability, and collaborative problem-solving." },
    { english: "Addressing Conflict", turkish: "Çatışma Çözme", example: "I understand there are different perspectives here. Let's find common ground and move forward together." },
    { english: "Acknowledging Effort", turkish: "Çabayı Takdir Etme", example: "I recognize the long hours you've invested. Your dedication hasn't gone unnoticed." },
    { english: "Encouraging Innovation", turkish: "Yenilikçiliği Teşvik", example: "Don't be afraid to challenge assumptions. I'm interested in your fresh perspectives on this." },
    { english: "Building Consensus", turkish: "Uzlaşı Sağlama", example: "Let's explore what we all agree on first, then address the areas where we differ." },
    { english: "Making Decisions", turkish: "Karar Verme", example: "After considering everyone's input, I've decided we'll proceed with option B because..." },
    { english: "Managing Change", turkish: "Değişimi Yönetme", example: "I know this transition is challenging. Here's how we'll support you through this process." }
  ],
