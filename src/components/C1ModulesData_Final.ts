...
**Key Social Justice Terms:**`,
  ...
  table: {
    title: "📋 Social Justice and Equality Vocabulary (Sosyal Adalet ve Eşitlik Kelime Dağarcığı)",
    data: [
      { category: "Equality vs Equity - Key Distinction", equality: "Equality (Eşitlik) - everyone gets same resources/treatment", equity: "Equity (Hakkaniyet) - everyone gets what they NEED to achieve equal outcomes", visual: "Equality = same size ladder for everyone | Equity = different ladders based on starting point", examples: "Equality: Everyone gets same textbook | Equity: Some get extra tutoring to reach same level", critical: "Equity recognizes different starting points and barriers!", note: "True fairness often requires equity, not just equality" },

      { category: "Discrimination - Unfair Treatment", what: "Discrimination (Ayrımcılık) - unfair treatment based on group membership", basis: "Race, gender, religion, age, disability, sexual orientation, nationality", types: "Direct (overt) vs Indirect (policies with discriminatory effects)", examples: "Refusing to hire women | Pay gap | Racial profiling | Accessibility barriers", illegal: "Many forms illegal, but still widespread", note: "Can be intentional or unintentional" },

      { category: "Privilege - Unearned Advantages", what: "Privilege (Ayrıcalık) - unearned advantages from social identity", invisible: "Often invisible to those who have it", examples: "White privilege, male privilege, class privilege, able-bodied privilege", not_about: "Not saying life is easy, just that certain barriers don't exist", acknowledge: "Acknowledging privilege = first step to dismantling inequality", note: "Privilege doesn't mean you didn't work hard - means you didn't face certain obstacles" },

      { category: "Diversity vs Inclusion", diversity: "Diversity (Çeşitlilik) - having people from different backgrounds present", inclusion: "Inclusion (Dahil Etme) - ensuring those people feel valued, respected, empowered", metaphor: "Diversity = invited to the party | Inclusion = asked to dance", both_needed: "Diversity without inclusion = tokenism", examples: "Diverse hiring | Inclusive culture, policies, decision-making", note: "Diversity is being counted, inclusion is being heard" },

      { category: "Bias - Prejudice in Action", conscious_bias: "Conscious Bias - aware prejudice (overt racism, sexism)", unconscious_bias: "Unconscious Bias (Önyargı) - automatic associations we're unaware of", impact: "Affects hiring, promotions, healthcare, education, justice", address: "Awareness, training, diverse perspectives, checking assumptions", examples: "Assuming engineer is male | Clutching purse around Black person | Talking louder to non-native speaker", note: "Everyone has biases - key is recognizing and counteracting them" },

      { category: "Marginalization - Pushed to Edges", what: "Marginalization (Marjinalleştirme) - systematically excluded from full participation", mechanisms: "Lack of representation, resources, voice in decisions", groups: "Racial minorities, LGBTQ+, people with disabilities, immigrants, poor", effects: "Limited opportunities, health disparities, political powerlessness", examples: "Lack of wheelchair access | Few women in leadership | Indigenous land rights ignored", note: "Opposite of inclusion - actively pushed out" },

      { category: "Intersectionality - Overlapping Identities", what: "Intersectionality (Kesişimsellik) - how multiple identities overlap and interact", coined_by: "Kimberlé Crenshaw (1989) - Black feminist legal scholar", examples: "Black woman faces both racism AND sexism (not just sum of parts) | Disabled immigrant | Poor LGBTQ+ person", why_matters: "Can't understand discrimination by looking at identities separately", critical: "Experiences aren't additive - they're multiplicative and unique!", note: "Essential framework for understanding complex inequalities" },

      { category: "Systemic/Structural Discrimination", systemic_racism: "Systemic Racism (Sistemik Irkçılık) - policies/practices embedded in institutions that disadvantage racial minorities", examples: "Redlining (housing), mass incarceration, school funding gaps, healthcare disparities", not_about: "Not about individual prejudice - about structures and systems", hard_to_see: "Often invisible, seems 'normal', perpetuates itself", vs_individual: "Individual racism = personal bigotry | Systemic = institutional patterns regardless of intent", note: "Can exist even without racist individuals" },

      { category: "Advocacy & Activism", advocacy: "Advocacy (Savunuculuk) - speaking up for marginalized groups, policy changes", activism: "Activism (Aktivizm) - active campaigning for social/political change", forms: "Protests, petitions, lobbying, awareness campaigns, organizing", allyship: "Allyship (Müttefiklik) - actively supporting marginalized communities with your privilege", examples: "March for rights | Donate to causes | Amplify marginalized voices | Vote for equity", note: "Advocacy can happen at individual, organizational, systemic levels" },

      { category: "Allyship - Being a Good Ally", listen: "Listen to marginalized people's experiences without defensiveness", amplify: "Amplify their voices - center their perspectives, not yours", educate: "Educate yourself - not their job to teach you", speak_up: "Speak up against injustice - use privilege for good", follow_lead: "Take direction from those most affected", mistakes: "When you mess up: apologize, learn, do better", note: "Allyship is ongoing action, not an identity" },

      { category: "Empowerment - Building Agency", what: "Empowerment (Güçlendirme) - giving people resources, agency, voice to control their lives", not: "Not doing things FOR people - enabling them to do for themselves", examples: "Skills training, leadership development, resource access, platform sharing", vs_charity: "Empowerment = sustainable change | Charity = temporary help", critical: "Nothing about us without us - involve affected communities!", note: "True empowerment shifts power, not just provides services" },

      { category: "Representation - Who's at the Table?", what: "Representation (Temsiliyet) - diverse people in media, leadership, decision-making", why_matters: "Challenges stereotypes, provides role models, better decisions, reflects reality", token: "Tokenism - one person to check diversity box (not real representation)", examples: "Women in STEM, People of color in government, Disabled actors playing disabled characters", quote: "'If you're not at the table, you're on the menu'", note: "Quality of representation matters, not just numbers" },

      { category: "Microaggressions - Death by 1000 Cuts", what: "Microaggressions (Mikro Saldırganlık) - subtle, often unintentional slights toward marginalized groups", examples: "'Where are you REALLY from?' | Touching Black hair | 'You're so articulate' (to Black person) | Assuming woman is nurse, not doctor", impact: "Cumulative effect causes stress, sense of not belonging", intent: "Often well-intentioned, but impact matters more than intent", response: "When called out: apologize, don't defend intent, learn", note: "Small individually, heavy cumulatively" },

      { category: "Cultural Sensitivity & Competence", sensitivity: "Cultural Sensitivity (Kültürel Duyarlılık) - respecting differences in beliefs, values, customs", competence: "Cultural Competence - effectively interacting across cultures", avoid: "Stereotyping, assumptions, cultural appropriation, ethnocentrism", practice: "Learn, ask questions, observe, adapt communication", examples: "Different eye contact norms, personal space, time orientation, decision-making styles", note: "Essential in diverse workplaces and globalized world" },

      { category: "Inclusive Language - Words Matter", people_first: "People-first: 'person with disability' (emphasizes humanity)", identity_first: "Identity-first: 'disabled person' (disability as part of identity)", respect: "Use language people prefer for themselves", examples: "LGBTQ+ (not 'lifestyle'), Latinx/Latine (gender-neutral), they/them pronouns, person experiencing homelessness (not 'homeless person')", avoid: "Slurs, outdated terms, dehumanizing language, unnecessary qualifiers", note: "Language evolves - stay informed and flexible" },

      { category: "Common Mistakes - Colorblind Approach", mistake: "'I don't see color' / 'I treat everyone the same'", problem: "Ignores real impacts of racism, dismisses experiences of people of color", better: "Acknowledge race matters, see AND value differences", examples: "Wrong: 'I don't see race' ✗ | Right: 'I recognize different experiences and commit to equity' ✓", note: "Seeing difference isn't the problem - devaluing difference is" },

      { category: "Common Mistakes - Centering Yourself", mistake: "Making discussions about your feelings as privileged person", examples: "'But I'm a good person!' | 'Not all men!' | 'I have a Black friend!' | 'What about reverse racism?'", problem: "Derails conversation, centers privileged experience", better: "Listen, acknowledge, learn - it's not about you", note: "Feeling uncomfortable ≠ being oppressed" },

      { category: "Remember", takeaway_1: "Equality = same treatment | Equity = fair treatment based on needs", takeaway_2: "Privilege = unearned advantages, often invisible to those who have it", takeaway_3: "Intersectionality = identities overlap, creating unique experiences", takeaway_4: "Systemic discrimination = built into institutions, not just individual prejudice", takeaway_5: "Allyship = ongoing action (listen, amplify, educate, speak up, follow lead)", final_note: "Social justice is about recognizing inequalities and working toward fairness - requires self-reflection, learning, and action!" }
    ]
  },
...
**Advanced Phrasal Verbs:**`,
  ...
  table: {
    title: "📋 Complex Phrasal Verbs for Professional Contexts (Profesyonel Bağlamlar için Karmaşık Fiil Öbekleri)",
    data: [
      { category: "Account for - Explain & Constitute", meaning: "Account for (Açıklamak, hesaba katmak) - to explain the reason for something OR to constitute/represent a portion", usage_1: "Explain cause: 'Poor weather accounted for the low turnout'", usage_2: "Constitute portion: 'Sales to Asia account for 40% of revenue'", examples: "These factors account for the decline in sales over the past quarter. | How do you account for the discrepancy in the budget?", common_mistakes: "✗ 'Account to' | ✓ 'Account for' (always 'for')", note: "Formal, professional tone - common in business, research, analysis" },

      { category: "Bear out - Confirm/Prove True", meaning: "Bear out (Doğrulamak) - to confirm, support, or prove that something is true", grammar: "Usually passive: 'be borne out by' evidence/facts/data", examples: "The research findings bear out our initial hypothesis about consumer behavior. | Her predictions were borne out by subsequent events.", formal_alternative: "Confirm, corroborate, substantiate, validate", common_mistakes: "✗ 'Bear up' (different: means to cope well) | ✓ 'Bear out' (confirm)", note: "Quite formal - common in academic, research, legal contexts" },

      { category: "Clamp down on - Take Strict Action", meaning: "Clamp down on (Sıkı önlemler almak) - to take strict action to stop or control something (usually undesirable behavior)", connotation: "Strong enforcement,严厉, often suggests crackdown or suppression", examples: "The government plans to clamp down on tax evasion with stricter penalties. | University clamped down on plagiarism after multiple incidents.", contexts: "Government enforcement, institutional rules, crime prevention, regulation", common_mistakes: "✗ 'Clamp down at/to' | ✓ 'Clamp down on' (always 'on')", note: "Often implies previously lax enforcement now becoming stricter" },

      { category: "Draw up - Prepare Formal Documents", meaning: "Draw up (Hazırlamak) - to prepare or write a formal document, plan, contract, or agreement", examples: "Our legal team will draw up the contract by the end of the week. | We need to draw up a budget proposal for the board meeting.", common_collocations: "Draw up a contract/agreement/plan/will/list/proposal/document", related_phrasal: "Draft = similar meaning but can be less formal", common_mistakes: "✗ 'Draw out' (different: means to prolong or extract) | ✓ 'Draw up' (prepare document)", note: "Professional, business, legal contexts - implies careful, formal preparation" },

      { category: "Fall through - Fail to Happen", meaning: "Fall through (Suya düşmek) - to fail to happen or be completed, usually because of problems", tone: "Disappointment, frustration - plans that were expected to succeed", examples: "The merger fell through due to regulatory complications. | Our vacation plans fell through when the flights were canceled.", common_collocations: "Plan/deal/agreement/arrangement/proposal falls through", common_mistakes: "✗ 'Fall down' (different: physically fall or fail completely) | ✓ 'Fall through' (plan fails)", note: "Often implies something was close to happening but then failed" },

      { category: "Hammer out - Reach Agreement Through Discussion", meaning: "Hammer out (Uzlaşmaya varmak) - to reach agreement on something through lengthy discussion and negotiation", imagery: "Like hammering metal into shape - requires effort, time, persistence", examples: "After hours of discussion, we finally hammered out an agreement. | The two countries hammered out a trade deal after months of negotiations.", common_collocations: "Hammer out an agreement/deal/compromise/solution/details/plan", tone: "Suggests difficulty but eventual success", note: "Implies hard work, back-and-forth discussion, eventual compromise" },

      { category: "Iron out - Resolve Problems/Details", meaning: "Iron out (Düzeltmek, halletmek) - to resolve problems, difficulties, or sort out details", imagery: "Like ironing wrinkles from fabric - smoothing out issues", examples: "We need to iron out a few technical issues before the product launch. | Let's meet to iron out the final details of the contract.", common_collocations: "Iron out problems/issues/difficulties/details/wrinkles/kinks/differences", common_mistakes: "✗ 'Iron up' | ✓ 'Iron out' (always 'out')", note: "Optimistic tone - implies problems are solvable, minor, or nearly resolved" },

      { category: "Phase out - Gradually Discontinue", meaning: "Phase out (Aşamalı olarak kaldırmak) - to gradually discontinue, eliminate, or replace something over time", opposite: "Phase in - gradually introduce something new", examples: "The company will phase out older models as new versions become available. | Many countries are phasing out single-use plastics.", common_contexts: "Technology upgrades, environmental policies, product lifecycles, organizational changes", common_mistakes: "✗ 'Phase off' | ✓ 'Phase out' (always 'out') | Don't confuse with 'face out' (completely different)", note: "Implies gradual, planned transition - not sudden elimination" },

      { category: "Rule out - Eliminate as Possibility", meaning: "Rule out (Olasılığı kaldırmak) - to eliminate something as a possibility or option", examples: "We can't rule out the possibility of further delays. | Doctors have ruled out cancer as the cause.", common_contexts: "Medical diagnosis, investigations, decision-making, problem-solving", opposite: "Can't rule it out = still possible | Ruled it out = no longer possible", common_mistakes: "✗ 'Rule off' | ✓ 'Rule out' | Negative contexts common: 'can't rule out', 'couldn't rule out'", note: "Often used in negative ('can't rule out') to say something is still possible" },

      { category: "Scale back - Reduce Size/Scope", meaning: "Scale back (Küçültmek, azaltmak) - to reduce the size, scope, or extent of something (often due to constraints)", opposite: "Scale up - increase size/scope", examples: "Budget constraints forced us to scale back our expansion plans. | The company scaled back production due to decreased demand.", common_collocations: "Scale back plans/operations/production/spending/ambitions", tone: "Often implies reluctance - forced reduction rather than desired", note: "Business, project management contexts - implies strategic reduction" },

      { category: "Shore up - Strengthen/Support", meaning: "Shore up (Desteklemek, güçlendirmek) - to support or strengthen something that might fail or is weak", origin: "From 'shore' (wooden support beam) used in construction/mining", examples: "The bank took measures to shore up its financial position. | Government efforts to shore up the economy during the recession.", common_collocations: "Shore up finances/defenses/support/confidence/position/economy", context: "Crisis management, financial stability, political support", note: "Implies preventive strengthening against potential failure or collapse" },

      { category: "Sift through - Examine Carefully/Thoroughly", meaning: "Sift through (Didik didik aramak, elemek) - to examine large amounts of material carefully to find what you need", imagery: "Like sifting flour - separating useful from useless", examples: "Researchers had to sift through thousands of documents to find relevant data. | Police are sifting through evidence to build their case.", common_collocations: "Sift through data/documents/evidence/information/applications/debris", tone: "Tedious, time-consuming work - searching for needles in haystacks", note: "Implies large volume of material and careful, systematic examination" },

      { category: "Stem from - Originate From", meaning: "Stem from (Kaynaklanmak) - to originate or arise from; to have as a cause or source", grammar: "Always followed by the source/cause: 'stems from + noun'", examples: "Many of these problems stem from poor communication between departments. | Her confidence stems from years of experience.", formal_alternative: "Originate from, arise from, result from, derive from", common_mistakes: "✗ 'Stem to' | ✓ 'Stem from' (always 'from') | ✗ Don't confuse with 'stem' (stop/prevent): 'stem the bleeding'", note: "Formal, analytical tone - explaining root causes and origins" },

      { category: "Ward off - Prevent/Repel", meaning: "Ward off (Savuşturmak, önlemek) - to prevent something bad from affecting or harming you; to repel", examples: "The company implemented security measures to ward off cyber attacks. | Vitamin C may help ward off colds.", common_collocations: "Ward off attacks/threats/danger/illness/criticism/competition", imagery: "Defensive action - like putting up a shield", related: "'Ward' alone can mean hospital section or legal guardian", note: "Protective, defensive action - preventing harm before it occurs" },

      { category: "Zero in on - Focus Specifically", meaning: "Zero in on (Odaklanmak, hedeflemek) - to focus attention or efforts on something specific, often after broader consideration", origin: "Military term - adjusting weapon sights to hit target accurately", examples: "The investigation zeroed in on the financial transactions from March. | After analyzing all options, we zeroed in on cost reduction as our priority.", progression: "Typically: broad search → narrow focus → zero in on specific target", common_mistakes: "✗ 'Zero on' (missing 'in') | ✓ 'Zero in on' (always 'in on')", note: "Implies deliberate narrowing of focus to specific, important element" },

      { category: "Common Patterns - Business & Formal Contexts", explanation: "Explanation/analysis: 'account for', 'stem from' | Documents: 'draw up' | Negotiation: 'hammer out', 'iron out' | Enforcement: 'clamp down on' | Change: 'phase out', 'scale back' | Investigation: 'sift through', 'zero in on' | Prevention: 'ward off', 'shore up' | Failure: 'fall through', 'rule out'", formality: "ALL these phrasal verbs are appropriate for professional, business, academic writing (unlike many casual phrasal verbs)", note: "Master these to sound sophisticated and professional in formal English" },

      { category: "Usage Tips - Avoiding Common Errors", preposition_errors: "✗ 'account TO' ✓ 'account FOR' | ✗ 'clamp down AT' ✓ 'clamp down ON' | ✗ 'zero ON' ✓ 'zero IN ON' | Prepositions are fixed - memorize them!", confusables: "Don't confuse: 'bear out' (confirm) vs 'bear up' (cope) | 'draw up' (prepare) vs 'draw out' (prolong) | 'fall through' (fail) vs 'fall down' (physically fall) | 'iron out' (resolve) vs 'iron' (press clothes)", formality: "These are formal enough for professional writing but natural in speech too", remember: "Many originated from physical actions: shore (wooden support), sift (separate), hammer (shape metal), iron (smooth fabric)" },

      { category: "Remember - Key Takeaways", takeaway_1: "These 15 phrasal verbs are professional-grade - appropriate for business, academic, formal contexts", takeaway_2: "Prepositions are FIXED: account FOR, clamp down ON, zero in ON, stem FROM (not negotiable!)", takeaway_3: "Many have formal one-word equivalents: bear out = confirm, stem from = originate, shore up = strengthen", takeaway_4: "Several suggest process over time: hammer out (negotiate), iron out (resolve), sift through (examine), phase out (discontinue)", takeaway_5: "Context matters: 'fall through' = disappointment, 'clamp down' = strict enforcement, 'shore up' = prevention", final_note: "Mastering these phrasal verbs is crucial for C1-level fluency in professional English. They're used constantly in business, research, law, and formal discourse. Practice them in context!" }
    ]
  },
...
**Colorful Phrasal Verbs:**`,
  ...
  table: {
    title: "📋 Idiomatic Phrasal Verbs - Sound Like a Native (Deyimsel Fiil Öbekleri - Anadili Gibi Konuş)",
    data: [
      { category: "Bite off more than you can chew - Overcommit", meaning: "Bite off more than you can chew (Kaldırabileceğinden fazlasını üstlenmek) - to take on more responsibilities than you can handle", imagery: "Trying to eat a piece of food too large for your mouth - you can't actually manage it", examples: "I bit off more than I could chew by taking three projects simultaneously. | Accepting both job offers would be biting off more than I can chew.", tone: "Admission of mistake or warning about overambition", common_mistakes: "✗ 'Bite more than you can chew' (missing 'off') | ✓ 'Bite off more than you can chew'", note: "Very common, natural idiom - use when you've overcommitted yourself" },

      { category: "Brush up on - Review/Practice", meaning: "Brush up on (Tazelemek, gözden geçirmek) - to review or practice something you learned before but haven't used recently", examples: "I need to brush up on my Spanish before the trip to Mexico. | She's brushing up on her presentation skills before the conference.", contexts: "Skills, languages, knowledge areas that get rusty from disuse", opposite: "Learn from scratch vs brush up on = review what you already know", common_mistakes: "✗ 'Brush on' (missing 'up') | ✓ 'Brush up on' | ✗ 'Brush up' without 'on' (need 'on' before the object)", note: "Implies you once knew it well but need refresher - not starting from zero" },

      { category: "Catch on - Become Popular OR Understand", meaning_1: "Catch on (Popüler olmak) - to become popular, fashionable, or widely accepted", meaning_2: "Catch on (Anlamak) - to finally understand something after initial confusion", examples: "The new dance style caught on quickly among teenagers. (popular) | It took me a while to catch on to the joke. (understand)", context_clue: "Usually context makes clear which meaning: trends catch on (popular), people catch on (understand)", common_mistakes: "Don't confuse with 'catch up on' (different: to do something you're behind on, like 'catch up on sleep')", note: "Two distinct meanings - context determines which one applies" },

      { category: "Come across - Encounter OR Give Impression", meaning_1: "Come across (Karşılaşmak, rastlamak) - to find or encounter something/someone unexpectedly", meaning_2: "Come across as (İzlenim vermek) - to give a particular impression or appear to be", examples: "I came across an interesting article while researching. (encounter) | She comes across as very confident in meetings. (impression)", grammar: "'Come across' = find | 'Come across as' = seem/appear as", common_mistakes: "✗ 'Come across like confident' | ✓ 'Come across as confident' (need 'as' for impression meaning)", note: "Very versatile - both meanings extremely common in everyday English" },

      { category: "Get away with - Avoid Punishment", meaning: "Get away with (Ceza almadan kurtulmak) - to do something wrong without being punished or facing consequences", tone: "Often implies something unethical, dishonest, or rule-breaking", examples: "You won't get away with submitting late assignments without penalty. | He got away with lying because nobody checked his story.", common_collocations: "Get away with murder/cheating/lying/breaking rules", opposite: "Get caught = didn't get away with it", note: "Negative connotation - implies wrongdoing, even if minor or humorous" },

      { category: "Get over - Recover Emotionally", meaning: "Get over (Atlatmak, üstesinden gelmek) - to recover from something emotionally difficult or upsetting", examples: "It took months for him to get over the breakup. | I can't get over how expensive everything has become! (shock/surprise)", common_collocations: "Get over a loss/breakup/disappointment/illness/shock/surprise", time_element: "Process takes time: 'still getting over', 'finally got over', 'can't get over'", common_mistakes: "Don't confuse: 'get over' (recover) vs 'get through' (endure difficult period) vs 'get by' (manage/survive)", note: "Can mean emotional recovery OR expressing surprise/disbelief ('I can't get over it!')" },

      { category: "Give in - Surrender/Yield", meaning: "Give in (Boyun eğmek, pes etmek) - to stop resisting and accept what someone wants, often after pressure", tone: "Often reluctant surrender - not happy about it, but accepting defeat", examples: "After much pressure, she finally gave in and agreed to the terms. | Don't give in to peer pressure—stick to your principles.", contexts: "Negotiations, pressure situations, temptations, demands", opposite: "Stand firm, hold out, resist", common_mistakes: "Don't confuse: 'give in' (surrender) vs 'give up' (quit entirely) vs 'give in to' (surrender to specific pressure)", note: "Often followed by 'to': 'give in to pressure/demands/temptation'" },

      { category: "Look down on - Regard as Inferior", meaning: "Look down on (Küçümsemek, hor görmek) - to regard someone as inferior or less important; to feel superior to", tone: "Negative, judgmental attitude - shows prejudice or snobbery", examples: "It's wrong to look down on people because of their background. | She looks down on anyone who didn't attend university.", opposite: "Look up to = admire, respect", contexts: "Social class, education, jobs, lifestyle choices - unfair judgment", common_mistakes: "✗ 'Look down at' (physical action) vs ✓ 'Look down on' (disrespect) - different meanings!", note: "Very negative behavior - implies arrogance, prejudice, lack of respect" },

      { category: "Make up for - Compensate", meaning: "Make up for (Telafi etmek, karşılamak) - to compensate for a deficiency or mistake by providing something positive", examples: "His enthusiasm made up for his lack of experience. | I'll work extra hours to make up for the time I missed.", common_collocations: "Make up for lost time/mistakes/shortcomings/lack of something", balance_concept: "Negative + positive = balanced out through compensation", common_mistakes: "Don't confuse: 'make up for' (compensate) vs 'make up' (reconcile after argument OR invent/fabricate)", note: "Implies something negative being balanced by something positive" },

      { category: "Put up with - Tolerate/Endure", meaning: "Put up with (Katlanmak, tahammül etmek) - to tolerate something unpleasant or annoying without complaining", tone: "Endurance of something you don't like but can't change", examples: "I can't put up with this noise any longer—I need to move. | She's been putting up with his bad behavior for years.", common_collocations: "Put up with noise/rudeness/delays/inconvenience/nonsense", limit_expression: "Often with 'can't' or 'won't': 'I can't put up with this anymore!'", note: "Implies patience wearing thin or reluctant tolerance of bad situation" },

      { category: "Run into - Encounter Unexpectedly", meaning: "Run into (Rastlamak, tesadüfen karşılaşmak) - to meet someone or encounter something unexpectedly", examples: "I ran into an old friend at the coffee shop yesterday. | We ran into some problems during the installation process.", dual_meaning: "People: meet by chance | Problems/obstacles: encounter difficulties", tone: "Casual, conversational - very common in everyday speech", common_mistakes: "Don't confuse: 'run into' (encounter) vs 'run out of' (deplete supply) vs 'run up' (accumulate debt/bills)", note: "One of the most natural, frequently used phrasal verbs in spoken English" },

      { category: "See through - Detect Deception", meaning: "See through (Görüp anlamak, içyüzünü görmek) - to recognize someone's true character or see past deception/facade", examples: "Everyone could see through his lies immediately. | I can see through your excuses—just tell me the truth.", tone: "Perception, insight - not being fooled by appearances", imagery: "Like seeing through transparent glass - seeing what's really behind the surface", common_mistakes: "Don't confuse: 'see through' (detect lies) vs 'see through something' (complete a task: 'see the project through to the end')", note: "Shows perceptiveness - ability to detect dishonesty or hidden motives" },

      { category: "Stand out - Be Noticeably Different", meaning: "Stand out (Göze çarpmak, öne çıkmak) - to be noticeably different, better, or more prominent than others", examples: "Her innovative approach really stood out among the other proposals. | His red jacket stood out in the crowd of dark suits.", contexts: "Competitions, comparisons, visual distinctiveness, exceptional performance", opposite: "Blend in, fit in = not stand out", tone: "Usually positive (excellence) but can be neutral (just different/visible)", note: "Excellence makes you stand out = positive | Visual difference = neutral observation" },

      { category: "Talk into - Persuade/Convince", meaning: "Talk into (İkna etmek, razı etmek) - to persuade someone to do something they were initially reluctant to do", examples: "My friends talked me into going to the concert even though I was tired. | The salesman talked her into buying the extended warranty.", process: "Initial resistance → persuasion/arguments → eventual agreement", opposite: "Talk out of = persuade NOT to do something ('She talked me out of quitting my job')", common_mistakes: "✗ 'Talk to do' | ✓ 'Talk into doing' (always 'into' + gerund)", note: "Can be neutral or slightly negative (suggests overriding someone's better judgment)" },

      { category: "Walk away from - Leave/Abandon", meaning: "Walk away from (Vazgeçmek, terk etmek, çekilmek) - to leave or abandon a situation, relationship, or opportunity", tone: "Often wise or principled decision - knowing when to quit", examples: "Sometimes the best option is to walk away from a bad situation. | He walked away from a lucrative job because it conflicted with his values.", contexts: "Bad deals, toxic relationships, unethical situations, lost causes", imagery: "Physical action of walking away = metaphor for disengagement", note: "Implies conscious, deliberate choice to disengage - not running away, but choosing to leave" },

      { category: "Formality & Usage - Everyday Idiomatic", level: "These are informal-to-neutral - perfect for conversation, less formal than Module 234 phrasal verbs", frequency: "EXTREMELY common in everyday spoken English - essential for natural fluency", non_literal: "Meanings can't be guessed from individual words ('bite off more than you can chew' ≠ eating!)", mastery: "Native speakers use these constantly - mastering them makes you sound natural", note: "Unlike Module 234's professional verbs, these are conversational staples" },

      { category: "Common Patterns - Multiple Meanings", dual_meanings: "'Catch on' (popular/understand) | 'Come across' (encounter/impression) | 'Get over' (recover/express surprise) | 'See through' (detect lies/complete task)", prepositions_matter: "'Look down ON' (disrespect) ≠ 'look down AT' (physical) | 'Brush up ON' (review) ≠ 'brush up' (incomplete) | 'Talk INTO' (persuade) vs 'talk OUT OF' (dissuade)", opposite_pairs: "'Give in' ↔ 'stand firm' | 'Stand out' ↔ 'blend in' | 'Look down on' ↔ 'look up to' | 'Talk into' ↔ 'talk out of'", note: "Context and prepositions completely change meanings - pay attention!" },

      { category: "Remember - Key Takeaways", takeaway_1: "These 15 phrasal verbs are highly idiomatic - meanings can't be guessed from individual words!", takeaway_2: "Many have dual meanings: 'catch on' (popular/understand), 'come across' (encounter/impression), 'get over' (recover/surprise)", takeaway_3: "Prepositions are critical: 'look down ON' (disrespect) ≠ 'look down AT' (physical glance downward)", takeaway_4: "Several express resistance/surrender: 'give in' (surrender), 'put up with' (tolerate), 'walk away from' (abandon)", takeaway_5: "Very common in everyday speech - essential for natural, native-like English conversation", final_note: "Master these to transform from formal-sounding to naturally fluent. Native speakers use these constantly in casual conversation. Practice them in real-life contexts!" }
    ]
  },
...
**Key Vocabulary and Expressions:**`,
  ...
  table: {
    title: "📋 Language of Persuasion and Influence (İkna ve Etki Dili)",
    data: [
      { category: "Persuasion vs Manipulation - Critical Distinction", persuasion: "Persuasion (İkna) - honest, ethical influence using reasoning/emotion, respects autonomy", manipulation: "Manipulation (Manipülasyon) - deceptive, self-serving control using tricks/lies, exploits vulnerabilities", key_difference: "Persuasion = wants genuine agreement | Manipulation = wants compliance/control", examples: "Persuasion: 'Let me show you why this benefits you' | Manipulation: Hiding downsides, false urgency, guilt-tripping", ethics: "Persuasion maintains trust and relationships | Manipulation destroys them when discovered", critical: "ALWAYS use ethical persuasion - manipulation is short-term gain, long-term loss!", note: "Persuasion respects the other person's right to say no" },

      { category: "The Three Pillars of Persuasion - Aristotle's Rhetoric", ethos: "Ethos (İnanılırlık) - establishing credibility, trust, authority, character", pathos: "Pathos (Duygusal çekicilik) - appealing to emotions, values, feelings, empathy", logos: "Logos (Mantık) - using logic, data, reason, evidence, rational argument", effective_persuasion: "Combines ALL THREE: credibility + emotion + logic = most powerful", examples: "Ethos: 'As a doctor with 20 years experience...' | Pathos: 'Imagine your children's future...' | Logos: 'Studies show 85% improvement...'", balance: "Too much ethos = arrogant | Too much pathos = manipulative | Too much logos = cold/boring", note: "Best persuasion: establish credibility (ethos) → connect emotionally (pathos) → provide evidence (logos)" },

      { category: "Making a Point - Direct Statements", what_im_trying_to_say: "What I'm trying to say is... (Söylemeye çalıştığım şey...)", let_me_put_it: "Let me put it this way... (Şöyle söyleyeyim...)", you_have_to_admit: "You have to admit that... (Kabul etmelisin ki...)", surely_youd_agree: "Surely you'd agree that... (Eminim kabul edersin ki...)", examples: "What I'm trying to say is we need to act now. | Let me put it this way: either we change or we fail. | You have to admit that the results speak for themselves.", tone: "Assertive but not aggressive - clarifying your position", note: "Use when you want to emphasize or reframe your main argument" },

      { category: "Convincing & Persuading - Strong Language", evidence_shows: "The evidence clearly shows... (Kanıtlar açıkça gösteriyor ki...)", no_denying: "There's no denying that... (İnkar edilemez ki...)", its_obvious: "It's obvious that... (Açıkça görülüyor ki...)", i_strongly_believe: "I strongly believe... (Şiddetle inanıyorum ki...)", examples: "The evidence clearly shows solar energy is cost-effective. | There's no denying that climate change is real. | It's obvious that we need better communication.", tone: "Confident, assertive - use when you have strong support for claims", warning: "Don't overuse - can seem arrogant if used without actual evidence!", note: "Pair with facts/data to avoid sounding like empty rhetoric" },

      { category: "Softening & Diplomacy - Gentle Persuasion", you_might_want: "You might want to consider... (Düşünmek isteyebilirsin...)", perhaps_we_could: "Perhaps we could look at it from another angle... (Belki başka açıdan bakabiliriz...)", it_could_be_argued: "It could be argued that... (Şu da iddia edilebilir ki...)", have_you_thought: "Have you thought about... (... düşündün mü?)", examples: "You might want to consider alternative approaches. | Perhaps we could explore other options first. | Have you thought about the long-term implications?", tone: "Diplomatic, respectful - suggests rather than demands", when_to_use: "When persuading someone resistant, in delicate situations, or with authority figures", note: "Makes suggestions non-threatening - gives person space to reach own conclusions" },

      { category: "Agreeing & Supporting - Building Rapport", fair_point: "That's a fair point. (Adil bir nokta.)", couldnt_agree_more: "I couldn't agree more. (Daha fazla katılamam - tamamen katılıyorum.)", exactly_what_i_was_thinking: "Exactly what I was thinking. (Tam da düşündüğüm şey.)", absolutely_right: "You're absolutely right. (Kesinlikle haklısın.)", examples: "That's a fair point, and I appreciate your perspective. | I couldn't agree more about the importance of transparency.", purpose: "Show you're listening, validate their views, build trust before disagreeing or redirecting", strategic_use: "Agree on small points to build rapport before persuading on major points", note: "People are more open to your ideas when they feel heard and validated first" },

      { category: "Disagreeing Politely - Respectful Opposition", i_see_your_point_but: "I see your point, but... (Noktanı görüyorum, ama...)", thats_one_way_however: "That's one way to see it; however... (Bu bir bakış açısı; ancak...)", not_entirely_convinced: "I'm not entirely convinced. (Tamamen ikna olmadım.)", with_respect: "With respect, I disagree. (Saygıyla, katılmıyorum.)", examples: "I see your point, but have you considered the costs? | That's one way to see it; however, the data suggests otherwise. | I'm not entirely convinced that's the best approach.", structure: "Acknowledge their view → signal disagreement gently → present alternative", tone: "Respectful, thoughtful - disagree with ideas, not the person", note: "Essential for professional debates, negotiations, and maintaining relationships while disagreeing" },

      { category: "Influencing Emotionally - Pathos Techniques", appeal: "Appeal (Başvuru) - calling to someone's desires, fears, values, or hopes", empathy: "Empathy (Empati) - showing understanding of their feelings and situation", credibility: "Credibility (İnanılırlık) - demonstrating trustworthiness and expertise", trust: "Trust (Güven) - foundation of persuasion, built through consistency and honesty", emotional_connection: "Create connection through shared values, personal stories, relatable examples", body_language: "55% of communication impact - eye contact, open posture, appropriate gestures", tone: "How you say it matters more than what you say - confidence, warmth, sincerity", note: "Emotion makes messages memorable - people remember how you made them feel" },

      { category: "Rhetorical Devices - Advanced Techniques", repetition: "Repetition (Tekrar) - reinforcing message until familiar and convincing ('Yes we can', 'I have a dream')", rhetorical_questions: "Rhetorical questions - engage mind, lead to desired conclusion ('Don't you want a better future?')", storytelling: "Storytelling (Hikaye anlatımı) - makes ideas relatable, memorable, emotionally engaging", rule_of_three: "Rule of three - 'Life, liberty, pursuit of happiness' | 'Government of, by, for the people'", metaphor_analogy: "Metaphors & analogies make abstract concrete ('information highway', 'time is money')", contrast: "Contrast creates impact: 'Ask not what your country can do for you—ask what you can do for your country'", note: "These devices have persuaded audiences for thousands of years - timeless power!" },

      { category: "Persuasive Techniques in Practice", scarcity: "Scarcity (Kıtlık) - 'Limited time offer!', 'Only 3 left!' creates urgency", social_proof: "Social proof (Sosyal kanıt) - 'Join 10 million users', testimonials, celebrity endorsements", reciprocity: "Reciprocity (Karşılıklılık) - giving something first creates obligation to give back", authority: "Authority (Otorite) - expert opinions, credentials, official endorsements", consistency: "Consistency - people want to act consistent with previous commitments", liking: "Liking (Beğenme) - we're persuaded by people we like - build rapport first", note: "Cialdini's 6 Principles of Influence - proven psychological triggers" },

      { category: "Contexts for Persuasion", sales: "Sales: Emphasize benefits over features, address objections, create urgency, build rapport", negotiations: "Negotiations: Find mutual benefits, make strategic concessions, frame as win-win", job_interviews: "Job interviews: Align skills with company goals, tell achievement stories, show confidence", presentations: "Presentations: Clear structure, compelling visuals, audience engagement, memorable opening/closing", debates: "Debates: Anticipate objections, use evidence effectively, stay calm under pressure", teaching: "Teaching: Show relevance and value, inspire curiosity, motivate through connection not authority", note: "Adapt persuasion style to context - what works in sales may not work in teaching!" },

      { category: "Active Listening - Foundation of Persuasion", why_it_matters: "You can't persuade if you don't understand their concerns, values, and objections", techniques: "Paraphrase to show understanding | Ask clarifying questions | Acknowledge emotions | Avoid interrupting", benefits: "Builds trust, shows respect, reveals what arguments will resonate, allows tailored responses", examples: "'So what I hear you saying is...' | 'Help me understand your concern about...' | 'I can see why that matters to you.'", common_mistake: "Talking too much and not listening - persuasion is dialogue, not monologue!", golden_ratio: "Listen 70%, speak 30% - the more they talk, the more they reveal what will persuade them", note: "Best persuaders are best listeners - understand before trying to be understood" },

      { category: "Timing & Context - When Matters", right_moment: "Deliver message when people are receptive, not stressed, rushed, or distracted", morning_vs_evening: "People more receptive to new ideas when fresh (morning) vs tired (evening)", after_success: "People more open after small successes - builds positive mindset", avoid_bad_timing: "Don't persuade when angry, during crisis, when hungry (seriously!), or when emotionally charged", context_matters: "Private vs public setting changes receptivity - some topics need privacy", prepare_ground: "Sometimes best persuasion is preparing conditions, not immediate pitch", note: "Even perfect arguments fail with poor timing - patience is persuasive strategy!" },

      { category: "Common Mistakes - What NOT to Do", mistake_1: "✗ Too pushy/aggressive - triggers resistance and defensiveness", mistake_2: "✗ Not listening - missing what actually matters to them", mistake_3: "✗ Making it about you - focus on THEIR benefits, not yours", mistake_4: "✗ Using logic alone - people need emotional connection too", mistake_5: "✗ Ignoring objections - address concerns directly, don't dismiss", mistake_6: "✗ Seeming desperate - undermines credibility and bargaining position", mistake_7: "✗ Lying or exaggerating - destroys trust permanently when discovered", remember: "Persuasion respects autonomy - if you can't win them over ethically, accept it!" },

      { category: "Ethical Persuasion - The Right Way", be_honest: "Never lie, exaggerate, or withhold critical information - trust is everything", respect_autonomy: "Respect their right to say no - persuasion isn't coercion", long_term_thinking: "Prioritize relationship over immediate win - you may need to persuade them again", win_win: "Seek mutual benefits - best persuasion leaves both parties satisfied", transparency: "Be clear about your interests and motivations - hidden agendas backfire", no_exploitation: "Never exploit vulnerabilities, fears, or desperation - that's manipulation", golden_rule: "Would you feel good being persuaded this way? If not, don't do it!", note: "Ethical persuasion builds reputation and trust that compounds over time" },

      { category: "Remember - Key Takeaways", takeaway_1: "Persuasion = ethical influence through ethos (credibility) + pathos (emotion) + logos (logic)", takeaway_2: "Manipulation = deceptive control that destroys trust - NEVER use it!", takeaway_3: "Listen 70%, speak 30% - understanding their concerns is foundation of persuasion", takeaway_4: "Use soft language for gentle persuasion: 'You might want to consider...', 'Perhaps we could...'", takeaway_5: "Timing matters as much as content - deliver message when they're receptive", takeaway_6: "Rhetorical devices (repetition, questions, storytelling, rule of three) make messages memorable", takeaway_7: "Common mistakes: too pushy, not listening, logic without emotion, ignoring objections", final_note: "Master persuasion to influence ethically in sales, negotiations, presentations, teaching, and relationships. The most persuasive people build trust, listen actively, and genuinely care about mutual benefits!" }
    ]
  },

  tip: `**The Three Pillars of Persuasion:**
...
**Key Vocabulary and Expressions:**`,
  ...
  table: {
    title: "📋 Expressing Doubt and Certainty at High Level (Şüphe ve Kesinlik İfade Etme)",
    data: [
      { category: "Why Calibration Matters - The Balance", problem: "Too much certainty = arrogant, dismissive, closed-minded | Too much doubt = unprepared, weak, indecisive", solution: "Calibrate language to match your actual knowledge level - be precisely as certain as evidence warrants", professional_contexts: "Academic writing, business presentations, expert testimony, medical diagnosis, scientific reporting", key_principle: "Intellectual honesty > appearing confident when you shouldn't be", examples: "Wrong: 'I'm 100% sure!' (when you're not) | Right: 'Based on available evidence, I'm quite confident that...'", note: "The most credible people know when to say 'I don't know' or 'I need more information'" },

      { category: "Expressing Complete Certainty - 100%", absolutely_convinced: "I'm absolutely convinced that... (Kesinlikle ikna oldum ki...)", without_doubt: "Without a doubt... / Beyond (any) doubt... (Şüphesiz...)", crystal_clear: "It's crystal clear that... (Çok açık ki...)", no_question: "There's no question that... (Hiç şüphe yok ki...)", with_confidence: "I can say with confidence that... (Güvenle söyleyebilirim ki...)", examples: "I'm absolutely convinced that she'll succeed. | Without a doubt, this is our best option. | There's no question that climate change is real.", when_to_use: "When you have strong evidence, personal experience, or undeniable facts", warning: "Use sparingly - overuse damages credibility when proven wrong!", note: "In academic writing, certainty requires evidence/citations to support" },

      { category: "Expressing Strong Belief - 90-95%", fairly_certain: "I'm fairly certain that... (Oldukça eminim ki...)", highly_likely: "It's highly likely that... (Oldukça olası ki...)", chances_are: "Chances are that... (Büyük ihtimalle...)", every_reason: "I have every reason to believe that... (... inanmak için her nedenim var)", examples: "I'm fairly certain she's at the office. | It's highly likely that prices will increase. | Chances are he already knows about it.", tone: "Confident but acknowledges slight possibility of being wrong", contexts: "Predictions, informed estimates, professional opinions with evidence", note: "Shows confidence while maintaining intellectual humility" },

      { category: "Expressing Moderate Certainty - 60-80%", seems_likely: "It seems likely that... (Görünüşe göre muhtemel ki...)", it_appears: "It appears that... (Görünüşe göre...)", from_what_i_can_tell: "From what I can tell... (Anladığım kadarıyla...)", could_very_well: "It could very well be that... (Çok muhtemel ki...)", probably: "Probably / Most likely / In all likelihood (Muhtemelen)", examples: "It seems likely that they'll accept the offer. | From what I can tell, the project is on track. | It could very well be a misunderstanding.", tone: "Tentative confidence - leaning toward belief but not committed", when_to_use: "Limited information, making educated guesses, softening predictions", note: "Academic writing often stays in this range to show critical thinking" },

      { category: "Expressing Doubt - 20-40%", not_entirely_sure: "I'm not entirely sure... (Tamamen emin değilim...)", doubtful: "It's doubtful that... (Şüpheli ki...)", some_uncertainty: "There's some uncertainty about... (...hakkında belirsizlik var)", wouldnt_bet_on_it: "I wouldn't bet on it... (Bahse girmezdim...)", have_my_doubts: "I have my doubts about that... (Bu konuda şüphelerim var...)", examples: "I'm not entirely sure that's the right approach. | It's doubtful we'll finish on time. | I have my doubts about whether this will work.", tone: "Expressing disbelief or lack of confidence without outright rejection", polite_version: "Use when you disagree but want to sound diplomatic", note: "More polite than direct disagreement - saves face in professional contexts" },

      { category: "Expressing Skepticism - Disbelief", hard_to_believe: "I find it hard to believe that... (İnanmakta zorlanıyorum ki...)", rather_unlikely: "That sounds rather unlikely. (Bu oldukça olasılık dışı görünüyor.)", seriously_question: "I seriously question whether... (... olup olmadığını ciddi şekilde sorguluyorum)", doesnt_add_up: "It doesn't quite add up. (Pek mantıklı gelmiyor.)", with_all_due_respect: "With all due respect, I'm skeptical. (Tüm saygımla, şüpheliyim.)", examples: "I find it hard to believe he completed it alone. | That sounds rather unlikely given the circumstances. | It doesn't quite add up - something's missing.", tone: "Polite disbelief - questioning without accusing", informal_versions: "'I don't buy it' | 'That sounds fishy' | 'Yeah, right' (sarcastic) | 'Pull the other one'", note: "Skepticism is valuable - prevents accepting false information too easily" },

      { category: "Hedging Language - Academic & Professional", might_be_the_case: "It might be the case that... (Durum şu olabilir ki...)", theres_a_chance: "There's a chance that... (Bir ihtimal var ki...)", as_far_as_i_know: "As far as I know... (Bildiğim kadarıyla...)", to_best_of_knowledge: "To the best of my knowledge... (Bilgim dahilinde...)", if_not_mistaken: "If I'm not mistaken... (Yanılmıyorsam...)", examples: "As far as I know, the meeting is tomorrow. | To the best of my knowledge, she's still working there. | If I'm not mistaken, we've met before.", purpose: "Protect yourself from being wrong, show humility, acknowledge information limits", academic_use: "Essential in research: 'The results suggest...', 'It appears that...', 'Further research is needed...'", note: "Hedging shows intellectual honesty, not weakness - mark of critical thinking" },

      { category: "Modal Verbs for Certainty - Must & Can't", must_strong_certainty: "Must (Zorunda olmak / -meli) - Strong logical certainty (90-95%)", must_examples: "'She must be at home' (her car is there) | 'He must be joking' (too absurd to be serious) | 'It must be expensive' (it's a luxury brand)", cant_impossibility: "Can't - Strong logical impossibility (95-100% sure it's NOT true)", cant_examples: "'That can't be right' (contradicts known facts) | 'She can't be serious' (too ridiculous) | 'He can't have finished already' (not enough time)", logic: "Based on deduction from evidence, not direct knowledge", grammar: "Must + base verb (present) | Must have + past participle (past)", note: "These express logical conclusion, not obligation in this context" },

      { category: "Modal Verbs for Possibility - Might/May/Could", might_may: "Might / May (Olabilir) - 30-50% possibility", might_examples: "'It might rain' | 'She may be late' | 'They might have forgotten' (past: might have + pp)", could: "Could (Olabilir) - 20-40% possibility, slightly less likely than might/may", could_examples: "'It could be true' | 'She could be right' | 'It could have been worse'", comparison: "May ≈ Might (interchangeable in modern English) | Could = slightly less likely", negative_forms: "Might not / May not / Couldn't (possibility something is NOT true)", note: "In questions, 'Could it be...?' is more common than 'Might it be...?'" },

      { category: "Certainty Spectrum - Visual Guide", scale_100: "100%: Without a doubt, Definitely, Certainly, Absolutely, I'm positive, Must be true", scale_90: "90%: I'm fairly certain, Highly likely, Almost certainly, Probably, Most likely, I'm confident that", scale_70: "70%: It seems likely, It appears, Presumably, I'd say, From what I can tell", scale_50: "50%: It's possible, Maybe, Perhaps, It could be, Might be, May be", scale_30: "30%: I doubt it, It's unlikely, Doubtful, I'm not sure, I have my doubts", scale_10: "10%: I seriously doubt, Very unlikely, I find it hard to believe, Almost impossible", scale_0: "0%: Definitely not, Absolutely not, Impossible, No way, Can't be true", note: "Choose expressions that match your actual confidence level!" },

      { category: "Idiomatic Certainty - Strong Expressions", you_can_bet: "You can bet your life on it. / You can take it to the bank. (Emin olabilirsin.)", no_two_ways: "No two ways about it. (Başka türlü olamaz.)", sure_as_sun: "As sure as the sun rises. / As sure as night follows day. (Güneş doğduğu kadar emin.)", shadow_of_doubt: "Beyond any shadow of a doubt. (En ufak şüphe olmaksızın.)", mark_my_words: "Mark my words. (Sözümü dinle - haklı çıkacağım.)", examples: "You can take it to the bank - she'll be there. | Mark my words, they'll regret this decision.", tone: "Very informal, conversational, emphatic", warning: "Don't use in academic or professional writing - too colloquial!", note: "Shows absolute personal conviction - stake your reputation on it" },

      { category: "Idiomatic Uncertainty - Informal Expressions", up_in_air: "It's up in the air. (Havada - belirsiz, karara bağlanmamış)", jurys_out: "The jury's still out. (Henüz karar verilmedi - sonuç belirsiz)", time_will_tell: "Time will tell. (Zaman gösterecek.)", anyones_guess: "It's anyone's guess. (Kimse bilmiyor - tamamen belirsiz)", touch_and_go: "It's touch and go. (Kritik, sonuç belirsiz)", examples: "The jury's still out on whether the policy will work. | Time will tell if we made the right decision. | It's anyone's guess what will happen next.", contexts: "Casual conversation, avoiding commitment, acknowledging uncertainty", note: "Useful for diplomatic avoidance of predictions when outcome unclear" },

      { category: "Academic & Professional Hedging", tentative_language: "The data suggests... | The results indicate... | It appears that... | Evidence points to...", limiting_scope: "In this study... | Based on available data... | Within these parameters... | Under these conditions...", acknowledging_limits: "Further research is needed... | More evidence is required... | This remains to be confirmed... | Additional studies may clarify...", purpose: "Show critical thinking, avoid overstatement, protect from being wrong, invite further investigation", examples: "'The results suggest a correlation, though causation remains unclear.' | 'Based on available data, it appears...'", tone: "Intellectual humility - hallmark of good academic writing", note: "Hedging is NOT weakness - it's precision and honesty about knowledge limits" },

      { category: "Context Matters - When to Use What", leadership_certainty: "Leaders need to project confidence - use stronger certainty to motivate and direct", academic_hedging: "Academics hedge extensively - shows critical thinking and invites peer review", sales_confidence: "Sales requires certainty about product benefits - but ethical honesty about limitations", medical_caution: "Doctors balance confidence (reassure patients) with caution (acknowledge medical uncertainty)", legal_precision: "Lawyers are extremely precise - 'allegedly', 'purportedly', 'it is claimed that'", casual_conversation: "Friends tolerate uncertainty - 'I dunno', 'Maybe', 'Could be'", note: "Adapt your certainty language to context and audience expectations!" },

      { category: "Common Mistakes to Avoid", mistake_1: "✗ Absolute certainty without evidence - damages credibility when wrong", mistake_2: "✗ Too much hedging - sounds unprepared, indecisive, lacking confidence", mistake_3: "✗ Confusing opinion with fact - 'It IS' vs 'I believe it is'", mistake_4: "✗ Not acknowledging limits - everyone has knowledge gaps, admit them!", mistake_5: "✗ Overusing 'I think' - weakens statements unnecessarily in some contexts", mistake_6: "✗ Being certain about predictions - future is inherently uncertain!", good_practice: "Match language to evidence | Acknowledge when you don't know | Be confident with facts, tentative with interpretations", note: "The most credible people are precisely calibrated - certain when warranted, humble when not" },

      { category: "Remember - Key Takeaways", takeaway_1: "Calibrate certainty to evidence - too much certainty = arrogant, too much doubt = weak", takeaway_2: "Certainty spectrum: 100% (definitely) → 90% (highly likely) → 70% (seems likely) → 50% (maybe) → 30% (doubtful) → 0% (impossible)", takeaway_3: "Modal verbs: MUST (strong certainty 90%+) | CAN'T (impossibility) | MIGHT/MAY/COULD (30-50% possibility)", takeaway_4: "Hedging language (academic): 'It appears that...', 'The data suggests...', 'To the best of my knowledge...'", takeaway_5: "Idiomatic certainty: 'You can bet on it', 'No two ways about it', 'Beyond shadow of doubt'", takeaway_6: "Context matters: Leaders need confidence | Academics need hedging | Adapt to audience", takeaway_7: "Intellectual honesty > false confidence - best experts know when to say 'I don't know'", final_note: "Master this to sound professional, credible, and appropriately confident in all contexts. Precision in expressing certainty is mark of critical thinking and expertise!" }
    ]
  },

  tip: `**Modal Verbs for Certainty:**
...
**Key Concepts:**`,
  ...
  table: {
    title: "📋 Using Metaphor and Simile in Speech (Konuşmada Metafor ve Benzetme Kullanımı)",
    data: [
      { category: "What Are Metaphors & Similes - Core Definitions", metaphor: "Metaphor (Metafor) - Direct comparison without 'like' or 'as': 'Time IS money'", simile: "Simile (Benzetme) - Comparison using 'like' or 'as': 'Time is LIKE money'", key_difference: "Metaphor creates stronger identification | Simile makes explicit comparison", examples: "Metaphor: 'He's a night owl' | Simile: 'He's like a night owl' (less forceful)", purpose: "Make language more vivid, memorable, emotionally resonant | Make abstract concrete", why_important: "Essential for natural, expressive English - native speakers use them constantly!", note: "Both create comparisons to help understand one thing through another" },

      { category: "Metaphor - Direct Comparison", definition: "States A IS B without 'like' or 'as' - creates direct identification", common_examples: "'Time is money' | 'He's a night owl' | 'Life is a journey' | 'She's a rock' | 'Knowledge is power'", how_it_works: "Takes qualities from B and applies them to A - transfers meaning through association", power: "Stronger than simile - doesn't say 'like,' so feels more definitive and impactful", examples: "'Her words were daggers' (sharp, painful, penetrating) | 'My mind is a battlefield' (conflict, chaos, struggle)", turkish_note: "Turkish: 'Hayat bir yolculuktur' = Life is a journey", note: "Most powerful when comparison is surprising yet feels inevitable" },

      { category: "Simile - Explicit Comparison", definition: "States A is LIKE B or AS _____ AS B - explicit comparison using 'like' or 'as'", common_examples: "'As brave as a lion' | 'Like a fish out of water' | 'Slept like a log' | 'As cold as ice' | 'Fights like a tiger'", structure_1: "Like: 'Life is like a box of chocolates' | 'She sings like an angel'", structure_2: "As...as: 'As free as a bird' | 'As clear as day' | 'As busy as a bee'", comparison_to_metaphor: "Softer than metaphor - explicitly marks the comparison rather than stating identity", examples: "'Her smile was like sunshine' (warmth, brightness, joy) vs 'Her smile WAS sunshine' (metaphor)", note: "More common in everyday speech - feels less literary than metaphor" },

      { category: "Extended Metaphor - Developed Comparison", definition: "A metaphor developed over multiple sentences or paragraphs", example_1: "'Life is a rollercoaster—full of ups, downs, sudden turns you never see coming, and moments that take your breath away.'", example_2: "'Success is a journey: you need a map (plan), fuel (motivation), rest stops (breaks), and patience for traffic (obstacles).'", purpose: "Explores multiple facets of comparison | Creates deeper understanding | More literary and sophisticated", contexts: "Speeches, essays, poetry, creative writing, motivational talks", example_business: "'Our company is a ship: we need a captain (leader), crew (team), clear destination (vision), and ability to weather storms (resilience).'", note: "Don't overextend - know when to stop or metaphor becomes confusing" },

      { category: "Dead Metaphor - Lost Impact Through Overuse", definition: "Metaphors so common we no longer notice them as figurative", examples: "'Foot of the mountain' | 'Heart of the city' | 'Leg of the table' | 'Head of the department' | 'Arm of the law'", why_dead: "Used so frequently they become literal - we don't visualize the comparison anymore", more_examples: "'Time flies' | 'See the point' | 'Grasp the idea' | 'Follow your heart' | 'Fall in love'", business_dead: "'Cash flow' | 'Market penetration' | 'Bottom line' | 'Climbing the ladder' | 'Think outside the box'", impact: "Not necessarily bad - they're convenient and understood, but lack freshness and creativity", note: "Use fresh metaphors when you want impact; dead ones work for clarity without drawing attention" },

      { category: "Mixed Metaphor - Inconsistent Combinations (Usually Accidental)", definition: "Combining two or more inconsistent metaphors - often humorous or confusing", examples: "✗ 'We'll burn that bridge when we get to it' (mixing 'burn bridges' + 'cross that bridge')", more_fails: "✗ 'It's not rocket surgery' (rocket science + brain surgery) | ✗ 'We'll nip it in the bud before it rears its ugly head' (mixing plant + animal)", why_wrong: "Creates illogical or impossible imagery - confuses rather than clarifies", when_funny: "Intentional mixed metaphors can be humorous | Politicians accidentally create them and get mocked", example_intentional: "Comedians deliberately mix metaphors for laughs: 'That's water under the fridge' (water under bridge + elephant in room)", note: "Avoid accidentally - keep your metaphors consistent throughout a passage!" },

      { category: "Common Metaphorical Themes - Universal Concepts", light_dark: "Light/Dark: 'ray of hope' | 'dark times' | 'brighten my day' | 'in the dark about' | 'shed light on'", journey: "Journey: 'life's a journey' | 'at a crossroads' | 'moving forward' | 'lost my way' | 'reached a milestone'", war_battle: "War/Battle: 'fighting for survival' | 'battle of wills' | 'armed with knowledge' | 'defeat the competition' | 'won the argument'", growth_plants: "Growth/Plants: 'seeds of doubt' | 'blossoming career' | 'branch out' | 'deeply rooted' | 'nip in the bud'", time_money: "Time/Money: 'time is money' | 'spend time' | 'invest effort' | 'waste time' | 'save time' | 'time budget'", weather: "Weather: 'storm of emotions' | 'weather the crisis' | 'cloud over' | 'raining complaints' | 'winds of change'", note: "These themes recur across cultures - tap into universal human experiences" },

      { category: "Positive Metaphors - Uplifting Language", shining_example: "A shining example (Parlak bir örnek) - someone who exemplifies excellence", ray_of_hope: "A ray of hope (Bir umut ışığı) - small sign of improvement in bad situation", heart_of_team: "The heart of the team (Takımın kalbi) - central, essential member who keeps everything together", breath_fresh_air: "A breath of fresh air (Temiz hava nefesi) - someone/something refreshing and welcome", beacon_of_light: "A beacon of light (Işık feneri) - guiding force in darkness or confusion", silver_lining: "Silver lining (Gümüş astar) - positive aspect in bad situation ('Every cloud has a silver lining')", examples: "'She's a breath of fresh air in our department.' | 'This success is a ray of hope for the future.'", note: "Use to inspire, motivate, and create positive associations" },

      { category: "Negative Metaphors - Warning & Criticism", ticking_time_bomb: "A ticking time bomb (Saatli bomba) - dangerous situation about to explode", dark_cloud: "A dark cloud over (Üzerinde kara bulut) - oppressive worry or threat hanging over situation", slippery_slope: "A slippery slope (Kaygan zemin) - situation that will inevitably lead to worse outcomes", dead_end: "A dead end (Çıkmaz sokak) - situation with no future or solution", train_wreck: "A train wreck (Tren kazası) - complete disaster unfolding", uphill_battle: "An uphill battle (Yokuş yukarı mücadele) - very difficult struggle against odds", examples: "'Ignoring this issue is a ticking time bomb.' | 'This plan is a slippery slope to failure.'", note: "Use carefully - powerful but can sound harsh or overly dramatic" },

      { category: "Descriptive Similes - Classic Comparisons", as_free_as_bird: "As free as a bird (Kuş kadar özgür) - completely unrestricted and independent", as_cold_as_ice: "As cold as ice (Buz gibi soğuk) - emotionally distant or physically very cold", fish_out_water: "Like a fish out of water (Sudan çıkmış balık) - uncomfortable in unfamiliar environment", as_clear_as_day: "As clear as day (Gün gibi aşikar) - completely obvious and unmistakable", sleep_like_log: "Sleep like a log (Kütük gibi uyumak) - sleep very deeply without moving", as_busy_as_bee: "As busy as a bee (Arı kadar meşgul) - constantly working and productive", fight_like_cats_dogs: "Fight like cats and dogs (Kedi köpek gibi kavga etmek) - constant arguing", examples: "'I slept like a log after that workout.' | 'The answer is as clear as day!'", note: "These are idiomatic - learn them as fixed expressions" },

      { category: "Creative Figurative Speech - Original Expressions", mind_battlefield: "'My mind is a battlefield' - internal conflict, competing thoughts, mental struggle", swimming_in_work: "'He's swimming in work' - overwhelmed, surrounded by tasks, barely keeping head above water", smile_sunshine: "'Her smile was sunshine' - warmth, brightness, joy, lifting spirits", drowning_paperwork: "'Drowning in paperwork' - buried under, can't breathe, overwhelmed by documents", words_needles: "'Her words were needles' - sharp, painful, penetrating, leaving wounds", heart_stone: "'His heart turned to stone' - became cold, unfeeling, hardened", examples: "'After the breakup, I was drowning in sadness.' | 'Her encouragement was oxygen to my motivation.'", note: "Most powerful when unexpected but still makes intuitive sense" },

      { category: "Idiomatic Metaphors - Fixed Expressions", break_ice: "Break the ice (Buzları eritmek) - start conversation to reduce tension", hit_nail_head: "Hit the nail on the head (Çivi çakmak) - exactly correct, precise", spill_beans: "Spill the beans (Sır vermek) - reveal secret information", have_cold_feet: "Have cold feet (Ayakları üşümek) - become nervous and hesitant before commitment", costs_arm_leg: "Costs an arm and a leg (Çok pahalı) - extremely expensive", piece_of_cake: "Piece of cake (Çocuk oyuncağı) - very easy task", examples: "'Let me break the ice with a joke.' | 'This project costs an arm and a leg!'", note: "Learn these as vocabulary - they're set phrases, not creative metaphors" },

      { category: "Using Metaphors in Professional Contexts", business: "Business: 'market penetration,' 'cash flow,' 'bottom line,' 'climbing the corporate ladder,' 'level playing field'", presentations: "Presentations: 'paint a picture,' 'roadmap ahead,' 'bridge the gap,' 'chart a course,' 'navigate challenges'", leadership: "Leadership: 'steer the ship,' 'rally the troops,' 'weather the storm,' 'chart the course,' 'fan the flames of innovation'", marketing: "Marketing: 'capture attention,' 'target audience,' 'viral spread,' 'brand identity,' 'win hearts and minds'", tech: "Tech: 'information highway,' 'cloud storage,' 'surfing the web,' 'viral content,' 'digital footprint'", academic: "Academic: 'building blocks of knowledge,' 'seeds of thought,' 'framework,' 'foundation,' 'pillars of theory'", note: "Professional fields have their own metaphorical vocabularies - learn them to sound expert" },

      { category: "Creating Original Metaphors - Guidelines", step_1: "1. Identify abstract idea you want to express (e.g., 'feeling overwhelmed')", step_2: "2. Find familiar, concrete image sharing qualities (e.g., 'drowning,' 'avalanche,' 'tsunami')", step_3: "3. Connect them: 'I'm drowning in responsibilities' | 'An avalanche of work buried me'", make_fresh: "Avoid clichés - seek unexpected but logical connections", test_it: "Does it create a clear mental picture? Does it add insight? Is it surprising yet sensible?", examples: "Cliché: 'Time flies' ✗ | Fresh: 'Time leaked away like water through my fingers' ✓", warning: "Don't mix metaphors | Don't over-extend | Don't make them too obscure", note: "Best metaphors feel both surprising and inevitable - 'Of course!'" },

      { category: "Cultural Considerations - Metaphors Vary", western_time: "Western cultures: 'Time is money' (commodity, scarce, valuable)", eastern_time: "Eastern cultures: Time more cyclical, less urgent | Different relationship with punctuality", animal_symbols: "Animals mean different things: Lion = courage (West) | Dragon = power/luck (East) | Owl = wisdom (West) vs death (some cultures)", colors: "Colors: White = purity (West) vs mourning (East) | Red = danger (West) vs luck/celebration (China)", universal: "Some metaphors cross cultures: Light/dark, up/down, journey, growth", translation_note: "Metaphors often don't translate directly - learn target culture's figurative language!", note: "Understanding cultural metaphors shows deeper language and cultural fluency" },

      { category: "Common Mistakes to Avoid", mistake_1: "✗ Overusing metaphors - makes speech feel forced or pretentious", mistake_2: "✗ Mixing metaphors - 'We'll burn that bridge when we come to it' (confusing!)", mistake_3: "✗ Using dead metaphors trying to sound creative - they're too familiar to impress", mistake_4: "✗ Obscure metaphors audience won't understand - defeats the purpose", mistake_5: "✗ Inappropriate tone - humorous metaphor in serious context or vice versa", mistake_6: "✗ Over-extending metaphors until they break down logically", good_practice: "Use sparingly for impact | Keep them clear and relevant | Match tone to context | Be culturally aware", note: "Less is more - one perfect metaphor > five mediocre ones" },

      { category: "Remember - Key Takeaways", takeaway_1: "Metaphor = direct comparison (A IS B: 'Time is money') | Simile = explicit comparison (A is LIKE B: 'Time is like money')", takeaway_2: "Extended metaphors develop comparison over multiple sentences | Dead metaphors lost freshness through overuse", takeaway_3: "Common themes: light/dark, journey, war, growth, time as money, weather as emotion", takeaway_4: "Positive metaphors: 'ray of hope,' 'breath of fresh air,' 'shining example' | Negative: 'ticking time bomb,' 'slippery slope,' 'dark cloud'", takeaway_5: "Classic similes: 'as cold as ice,' 'like a fish out of water,' 'sleep like a log' - learn as fixed phrases", takeaway_6: "Create original metaphors: identify abstract idea → find concrete image → connect surprisingly but logically", takeaway_7: "Professional contexts have metaphorical vocabularies (business, tech, academic) - master them for credibility", final_note: "Metaphors and similes make English vivid, memorable, and emotionally resonant. They're markers of fluency and creativity. Master them to sound native-like and add personality to your communication!" }
    ]
  },

  tip: `**Common Metaphorical Themes:**
• Light/Dark, Journey, War, Growth, Time, Money, Weather`,
