...
async function loadModuleData(moduleId: number): Promise<any> {
  ...
  try {
    if (moduleId >= 1 && moduleId <= 150) {
      ...
      moduleData = module[`MODULE_${moduleId}_DATA`];
    } else if (moduleId >= 251 && moduleId <= 290) {
      // C2 modules (251-290)
...
const ORDER_C2 = [251,252,253,254,255,256,257,258,259,260,261,262,263,264,265,266,267,268,269,270,271,272,273,274,275,276,277,278,279,280,281,282,283,284,285,286,287,288,289,290];
            ...
            {MODULES_BY_LEVEL[selectedLevel as keyof typeof MODULES_BY_LEVEL].length === 0 ? (
              ...
              return (
                <Card 
                  ...
                  onClick={() => {
                    if (isUnlocked && ((module.id >= 1 && module.id <= 50) || (module.id >= 51 && module.id <= 100) || (module.id >= 101 && module.id <= 150) || (module.id >= 151 && module.id <= 200) || (module.id >= 201 && module.id <= 250) || (module.id >= 251 && module.id <= 290))) { // All A1, A2, B1, B2, C1, C2 modules are implemented
                      narration.cancel();
