...
fail / pass - kalmak / geçmek`,
  ...
  table: {
    ...
    data: [
      ...
      { category: "Study Activities", phrase: "do homework", turkish: "ödev yapmak", usage: "Complete school work at home", note: "After-school work", phrase: "I have to do my homework", also: "homework assignment" },
      ...
      { category: "Study Activities", phrase: "give a presentation / make a presentation", turkish: "sunum yapmak", usage: "Present information to class", note: "Public speaking practice", also: "do a presentation", phrase: "give a presentation on..." },
      ...
      { category: "Academic Performance", phrase: "pass / fail", turkish: "geçmek / kalmak", usage: "Succeed or not succeed in exam/course", examples: "Pass an exam / Fail a test", note: "Binary outcome", pass_mark: "Usually 50% or 60%", phrase: "Did you pass or fail?" },
