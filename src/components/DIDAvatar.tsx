...
interface DIDAgent {
  ...
  stop?: () => void;
  // Add other D-ID agent methods as needed
}

interface WindowWithDIDAgent extends Window {
  'did-agent'?: DIDAgent;
}

declare const window: WindowWithDIDAgent;
...
export default function DIDAvatar({ 
  ...
  const agentRef = useRef<DIDAgent | null>(null);
